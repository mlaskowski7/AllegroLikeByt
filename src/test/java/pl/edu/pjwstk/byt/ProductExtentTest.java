...
public class ProductExtentTest {
    ...
    private void clearExtent() throws Exception {
        Field field = Product.class.getDeclaredField("extent");
    ...
    @Test
    void loadExtent_afterSaving_loadsAllProducts() throws Exception {
        // given
        var product1 = new Product("Product 1", "Description 1", 10.0, 5, List.of("image1.jpg"));
        var product2 = new Product("Product 2", "Description 2", 20.0, 10, List.of("image2.jpg"));
        Product.saveExtent();
    ...
    @Test
    void saveAndLoadExtent_preservesProductAttributes() throws Exception {
        // given
